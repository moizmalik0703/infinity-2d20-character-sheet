...
function printSkillTable(skills) {
  ...
  return `<div class="print-skills-panel">
...
const PRINT_WINDOW_MARKER = "Infinity 2D20 Compact Portfolio v14 - equal Skills Source columns";
...
<head>
  ...
  <style>
    ...
    @media print {
      ...
      body.print-window #printPortfolio { display: block !important; }
      /* v14 hard guarantee: both Skills panels use the same fixed source-column geometry. */
      .print-skills-grid { display: flex !important; width: 100% !important; gap: 1.7mm !important; align-items: flex-start !important; }
      .print-skills-panel { flex: 0 0 calc((100% - 1.7mm) / 2) !important; width: calc((100% - 1.7mm) / 2) !important; min-width: 0 !important; }
      .print-skills-table { width: 100% !important; min-width: 0 !important; table-layout: fixed !important; }
...
document.addEventListener("DOMContentLoaded", () => {
  document.documentElement.dataset.infinityBuild = "v14-cacheproof";
  initLists();
  buildMainSkills();
